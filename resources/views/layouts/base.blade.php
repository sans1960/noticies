...
<body>
   <nav class="w-full py-2 bg-blue-800 shadow">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between">
            ...
            <div class="flex justify-center text-lg no-underline text-white pr-6">
            	@if (Route::has('login'))
            	<div class="  top-0 right-0 px-2 py-2 sm:block">
            		@auth
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
      ...
      <span class="ml-3 text-xl">Noticies</span>
    </a>
    <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 202i Noticies —
